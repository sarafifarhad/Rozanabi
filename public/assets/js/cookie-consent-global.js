(function(){
  ...
  var css = '' +
    '.cookie{position:fixed;right:18px;bottom:18px;z-index:9999;width:min(760px,calc(100vw - 36px));max-height:min(80vh,640px);overflow:auto;padding:22px 24px;border:1px solid rgba(255,255,255,.15);border-radius:24px;background:linear-gradient(145deg,rgba(18,18,34,.985),rgba(34,22,58,.985));box-shadow:0 24px 70px rgba(0,0,0,.42);color:#f8f6ff;font-family:Inter,DM Sans,system-ui,-apple-system,Segoe UI,sans-serif;display:none}' +
    ...
    '.cookie__head{display:flex;gap:12px;align-items:center;margin-bottom:12px;padding-right:40px}.cookie__icon{width:36px;height:36px;border-radius:12px;display:grid;place-items:center;background:rgba(207,179,91,.14);color:#cfb35b;flex:0 0 auto}.cookie__icon svg{width:20px;height:20px}.cookie__title{font-size:18px;line-height:1.2;margin:0;color:#fff}.cookie__body{font-size:13.2px;line-height:1.62;color:rgba(248,246,255,.8);margin:0 0 14px;max-width:64ch}.cookie__prefs{display:none;margin:12px 0 16px}.cookie__prefs.show{display:grid;gap:10px}.cookie__pref{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:12px;border:1px solid rgba(255,255,255,.12);border-radius:16px;background:rgba(255,255,255,.045)}.cookie__pref-title{font-size:13px;font-weight:700;color:#fff}.cookie__pref-desc{font-size:11.7px;line-height:1.42;color:rgba(248,246,255,.68);margin-top:4px}.cookie__toggle{width:40px;height:21px;accent-color:#cfb35b;flex:0 0 auto}.cookie__actions{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;align-items:stretch}.cookie__btn{border:1px solid rgba(255,255,255,.14);border-radius:999px;padding:11px 10px;font-family:Inter,DM Sans,system-ui,-apple-system,Segoe UI,sans-serif;font-weight:800;font-size:10.8px;line-height:1.15;letter-spacing:.08em;text-transform:uppercase;white-space:normal;text-align:center;display:inline-flex;align-items:center;justify-content:center;cursor:pointer;color:#fff;background:rgba(255,255,255,.08);min-height:42px;min-width:0}.cookie__btn--accept,.cookie__btn--save{background:#cfb35b;color:#171326;border-color:#cfb35b}.cookie__btn--accept:hover,.cookie__btn--accept:focus-visible,.cookie__btn--save:hover,.cookie__btn--save:focus-visible{background:#d8bd73;color:#171326;border-color:#d8bd73;text-shadow:none}.cookie__btn--decline{background:rgba(255,255,255,.04)}.cookie__btn--manage{background:rgba(109,75,196,.18);border-color:rgba(167,137,255,.32)}.cookie__btn.is-hidden-init{display:none!important}[data-cookie-settings]{font:inherit;color:inherit;background:none;border:0;text-decoration:none!important;text-underline-offset:0;cursor:pointer;padding:0}.demo-cookie-settings-wrap{margin-top:12px}.demo-cookie-settings{opacity:.76}.demo-cookie-settings:hover{opacity:1}@media(max-width:860px){.cookie{width:min(620px,calc(100vw - 30px));padding:18px 18px 16px}.cookie__actions{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:560px){.cookie{left:10px;right:10px;bottom:10px;width:auto;max-height:min(76vh,560px);padding:14px;border-radius:17px}.cookie__head{gap:9px;margin-bottom:8px}.cookie__icon{width:30px;height:30px}.cookie__title{font-size:15.5px}.cookie__body{font-size:12.2px;line-height:1.48;margin-bottom:10px}.cookie__actions{display:grid;grid-template-columns:1fr 1fr;gap:7px}.cookie__btn{width:100%;padding:10px 8px;font-size:10px;letter-spacing:.06em;min-height:40px}.cookie__pref{padding:9px}.cookie__pref-desc{display:none}}';
